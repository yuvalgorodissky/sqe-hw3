...
## Step files
The step files in the [src/test/java/moodle_test/StepDefinitions] directory contain the code that defines how each sentence in the feature files is translated to Selenium actions. See the files for a detailed description of the implementation.
